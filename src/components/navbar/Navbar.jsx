...
import LogoutComponent from '../../pages/registration/LogoutComponent'
    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-40 lg:hidden" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-40 flex">
          ...
          >
            <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
              ...
              <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                ...
                <div className="flow-root">
                {user?.user?.email=== "gopal@gmail.com" ?  <Link to={'/dashboard'} className="-m-2 block p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    admin
                  </Link> : ""}
                  </div>
          ...
          <LogoutComponent  logout={logout}/>
                ...
                <div className="flow-root">
                  <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                    ...
                    src="https://images.unsplash.com/photo-1527719197793-6b777854108d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fG1hbiUyMG1vZGVsfGVufDB8fDB8fHww"
         ...
         {/* desktop  */}
         <header className="relative bg-white"  style={{fontFamily:'Poppins,sans-serif'}}>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/home'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black flex  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Dukan <GiShoppingBag style={{marginTop:'2px'}} size={25}/></h1>
                  </div>
                </Link>
              </div>
