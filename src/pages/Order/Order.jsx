...
function Order() {
  ...
  return (
    <Layout>
      ...
      {order.length > 0 ?
        (<>
          <div className=" h-full pt-10" style={{fontFamily:'Poppins,sans-serif'}}> 
            <h1 style={{padding:'20px',textAlign:'center',fontWeight:'bold', fontSize:'35px'}}>Your Orders</h1>
            {
                        ...
                        return (
                          <div className="rounded-lg md:w-2/3">
                            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                              <img src={item.imgUrl} alt="product-image" className="w-full rounded-lg sm:w-40" />
